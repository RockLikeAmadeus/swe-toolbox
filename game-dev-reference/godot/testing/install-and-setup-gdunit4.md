1. Set the `$ ECHO $GODOT_BIN` to check if the environment variable is set to the path to Godot. If not, [set it](/game-dev-reference/godot/how-to/installation-and-setup.md#set-system-wide-environment-variable) (use `GODOT_BIN="/opt/Godot_44/Godot_44"`).
